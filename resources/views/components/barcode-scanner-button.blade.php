<div
    ...
    x-load-js="[@js(\Filament\Support\Facades\FilamentAsset::getScriptSrc('barcode-scanner', package: 'theofanisv/filament-barcode-scanner'))]"
    ...
    >
        ...
        <div class="relative min-h-screen flex items-center justify-center p-4">
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full p-6">
                ...
                <!-- Scanner Container -->
                <div id="barcode-reader" class="rounded-lg overflow-hidden bg-black"></div>
...
@once
    @push('scripts')
        <!-- Preload html5-qrcode library from CDN -->
        <script>
            // Preload the library for faster initialization
            if (typeof Html5Qrcode === 'undefined') {
                const link = document.createElement('link');
                link.rel = 'preload';
                link.as = 'script';
                link.href = 'https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js';
